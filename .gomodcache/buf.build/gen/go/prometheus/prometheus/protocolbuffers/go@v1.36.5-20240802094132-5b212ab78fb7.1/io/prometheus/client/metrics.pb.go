...
func (b0 Histogram_builder) Build() *Histogram {
	...
	_, _ = b, x
	x.SampleCount = b.SampleCount
	x.SampleCountFloat = b.SampleCountFloat
	x.SampleSum = b.SampleSum
	x.Bucket = b.Bucket
	x.CreatedTimestamp = b.CreatedTimestamp
	x.Schema = b.Schema
	...
	x.ZeroCountFloat = b.ZeroCountFloat
	x.NegativeSpan = b.NegativeSpan
	x.NegativeDelta = b.NegativeDelta
	x.NegativeCount = b.NegativeCount
	x.PositiveSpan = b.PositiveSpan
	x.PositiveDelta = b.PositiveDelta
	x.PositiveCount = b.PositiveCount
...
func (b0 Bucket_builder) Build() *Bucket {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.CumulativeCount = b.CumulativeCount
	x.CumulativeCountFloat = b.CumulativeCountFloat

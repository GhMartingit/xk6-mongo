...
var standardFilters = []types.GomegaMatcher{
	...
	IgnoringCreator("github.com/bsm/ginkgo/v2/internal.(*genericOutputInterceptor).ResumeIntercepting"),
	IgnoringCreator("github.com/bsm/ginkgo/v2/internal.(*genericOutputInterceptor).ResumeIntercepting..."),
	IgnoringCreator("github.com/bsm/ginkgo/v2/internal.RegisterForProgressSignal"),
